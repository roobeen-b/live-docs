...
export const updateDocumentAccess = async ({
  ...
  try {
    ...
    console.log(`Error occured while updating a room access: ${error}`);
  }
};
...
export const removeCollaborator = async ({
  ...
  try {
    ...
    console.log(`Error occured while removing a collaborator: ${Error}`);
  }
};
...
export const deleteDocument = async (roomId: string) => {
  try {
    ...
    console.log(`Error occured while deleting a document: ${error}`);
  }
};
